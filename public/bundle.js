...
const ArticleCollection = {
  ...
  getAllArticles: () => {
    ...
    return fetch(`http://localhost:8089/articles?userId=${activeUserId}`).then(r => r.json());
  },
  ...
  getSingleArticle: articleId => {
    return fetch(`http://localhost:8089/articles/${articleId}`).then(r => r.json());
  },
...
var _default = ArticleCollection;
exports.default = _default;
...
const activateDeleteButtons = () => {
  ...
  document.querySelector("#articles-output").addEventListener("click", () => {
    ...
    if (event.target.classList.contains("delete")) {
      ...
      const idToDelete = event.target.id.split("-")[1]; // Delete Selected Article (by ID), Defined by the Constant (const) Above:

      _ArticleCollection.default.deleteArticle(idToDelete) // Displays ALL [Other, Non-Deleted] News Articles:
      .then(_ArticleList.default);
    }
  });
}; // Export Functionality to be Imported by Any Other Module:
...
},{"./ArticleCollection":3,"./ArticleList":7}],5:[function(require,module,exports){
"use strict";
...
var _ArticleSaveEdit = _interopRequireDefault(require("./ArticleSaveEdit"));
...
const activateEditButton = () => {
  (0, _ArticleSaveEdit.default)(); // Select Articles Output ("#articles-output") as Target of Event Listener:
  ...
  document.querySelector("#articles-output").addEventListener("click", () => {
    ...
    if (event.target.classList.contains("reddit")) {
      ...
      _ArticleCollection.default.getSingleArticle(event.target.id.split("-")[1]) // Define Single Article Values for Title, Timestamp, Synopsis, and URL; Change "Save-Article" Text to "Edit Article";
      // Tie / Correlate Save (Edit) Article ID to Single Article ID (singleArticle.id):
      .then(singleArticle => {
        // var moment = require("moment");
        document.querySelector("#article-title").value = singleArticle.title; // Date and Time Omitted From Change Value(s):
...
},{"./ArticleCollection":3,"./ArticleSaveEdit":9}],6:[function(require,module,exports){
"use strict";
...
var _ArticleObjectBuilder = _interopRequireDefault(require("./ArticleObjectBuilder"));
  ...
  activateSaveButton: () => {
    document.querySelector("#article-form-output").addEventListener("click", () => {
      ...
      if (event.target.id === "save-article") {
        // Get User Input:
        const titleVal = document.querySelector("#article-title").value; // Date Omitted From Collection:
        ...
        const urlVal = document.querySelector("#article-url").value; // Turn User Input into Object:

        const objectToPost = (0, _ArticleObjectBuilder.default)(titleVal, timeVal, synopsisVal, urlVal);
        console.log(objectToPost); // Save the Object to Database:

        _ArticleCollection.default.saveNewArticle(objectToPost).then(() => {
          // Once POST is Complete, Print All [News] Articles (Again):
          (0, _ArticleList.default)(); // Clear Form Values:

          document.querySelector("#article-title").value = ""; // document.querySelector("#article-date").value = "";
          // document.querySelector("#article-timestamp").value = "";

          document.querySelector("#article-synopsis").value = "";
          document.querySelector("#article-url").value = ""; // document.querySelector("#article-form").innerHTML = ""
        });
      }
    });
  },
...
},{"../../lib/node_modules/moment":1,"./ArticleCollection":3,"./ArticleList":7,"./ArticleObjectBuilder":8}],7:[function(require,module,exports){
"use strict";
...
var _ArticleCollection = _interopRequireDefault(require("./ArticleCollection.js"));
...
const ArticleList = () => {
  ...
  _ArticleCollection.default.getAllArticles().then(articles => {
    ...
    articles.forEach(singleArticle => {
      document.querySelector("#articles-output").innerHTML += (0, _Article.default)(singleArticle);
    });
  });
}; // Export Functionality to be Imported by Any Other Module:
...
},{"../../lib/node_modules/moment":1,"./Article.js":2,"./ArticleCollection.js":3}],8:[function(require,module,exports){
"use strict";
...
const handleEditedArticle = () => {
  ...
  document.querySelector("#article-form-output").addEventListener("click", () => {
    var moment = require("../../lib/node_modules/moment"); // Target Edit Article ID; If Included, Get User Input:


    if (event.target.id.includes("reddit-article")) {
      // Get User Input (Title, Timestamp, Synopsis, and URL + Article ID [Split]):
      const titleVal = document.querySelector("#article-title").value; // const dateVal = document.querySelector("#article-date").value;
      // Moment.js Utilized to Parse, validate, manipulate, and display dates and times in JavaScript:

      const timeVal = moment(Date.now()).format();
      const synopsisVal = document.querySelector("#article-synopsis").value;
      const urlVal = document.querySelector("#article-url").value; // Get User Input (Article ID Split):

      const articleId = event.target.id.split("-")[2]; // Turn User Input into Object (Title, Timestamp, Synopsis, and URL):

      const objectToPost = (0, _ArticleObjectBuilder.default)(titleVal, timeVal, synopsisVal, urlVal); // Load Existing Articles from Storage; Edit / Put Selected Article (by ID):

      _ArticleCollection.default.editArticle(articleId, objectToPost).then(() => {
        // Write Edited Article [Form] to 'Storage':
        document.querySelector("#article-form-output").innerHTML = _ArticleForm.default.buildForm(); // Displays ALL News Articles:
...
var _default = handleEditedArticle;
exports.default = _default;

},{"../../lib/node_modules/moment":1,"./ArticleCollection":3,"./ArticleForm":6,"./ArticleList":7,"./ArticleObjectBuilder":8}],10:[function(require,module,exports){
"use strict";
...
var _ArticleForm = _interopRequireDefault(require("./ArticleForm.js"));

var _ArticleDeletion = _interopRequireDefault(require("./ArticleDeletion.js"));

var _ArticleEditForm = _interopRequireDefault(require("./ArticleEditForm.js"));
...
const loadPageAfterLogin = () => {
  ...
  // document.querySelector("#article-form-output").innerHTML = logOutHandler.renderLogOutButton();
  // Add 'Click' Event to Logout Button
  // logOutHandler.activateLogOutButton();
  //Builds Article Form
  document.querySelector("#article-form-output").innerHTML += _ArticleForm.default.buildForm(); // Adds Event Listener to Save Button

  _ArticleForm.default.activateSaveButton(); // Builds [News] Article List


  (0, _ArticleList.default)(); // Activate Delete Button(s)

  (0, _ArticleDeletion.default)(); // Activate Edit Button(s)

  (0, _ArticleEditForm.default)();
};

var _default = loadPageAfterLogin;
exports.default = _default;

},{"./ArticleDeletion.js":4,"./ArticleEditForm.js":5,"./ArticleForm.js":6,"./ArticleList.js":7}],11:[function(require,module,exports){
"use strict";
...
},{"./login":14,"./logout":15,"./register":17}],13:[function(require,module,exports){
"use strict";
...
var _loadPageAfterLogin = _interopRequireDefault(require("../NewsArticle/loadPageAfterLogin"));

var _ArticleForm = _interopRequireDefault(require("../NewsArticle/ArticleForm"));

var _ArticleList = _interopRequireDefault(require("../NewsArticle/ArticleList"));
  ...
  login: () => {
    ...
    _apiManager.default.userLogin(userVal).then(parsedUser => {
      if (passVal === parsedUser[0].password) {
        ...
        document.querySelector(".logout_1").innerHTML = _taskForm.default.loggout();
        sessionStorage.setItem("userId", parsedUser[0].id); // document.querySelector(".article-attempt").innerHTML = ""

        (0, _printAllEvents.default)();
        (0, _printTask.default)();
        (0, _loadPageAfterLogin.default)(); // document.querySelector(".create-article-attempt").innerHTML = ArticleForm.createArticle()
        // ArticleList()
      } else {
...
},{"../NewsArticle/ArticleForm":6,"../NewsArticle/ArticleList":7,"../NewsArticle/loadPageAfterLogin":10,"../events/printAllEvents":24,"../task/printTask":31,"../task/taskForm":33,"./apiManager":11,"./forms":13}],15:[function(require,module,exports){
"use strict";
...
},{"./clicks":12,"./forms":13}],16:[function(require,module,exports){
"use strict";
...
const register = {
  ...
  handleRegister: () => {
    ...
    _apiManager.default.addUser(userInput).then(parsedUser => {
      sessionStorage.setItem("userId", parsedUser.id); // // document.querySelector("#login").innerHTML = authForm.main()
      // document.querySelector("#jh-home").innerHTML = ""
...
},{"../NewsArticle/loadPageAfterLogin":10,"../events/printAllEvents":24,"../task/taskForm":33,"./apiManager":11,"./forms":13,"./objectBuilder":16}],18:[function(require,module,exports){
"use strict";
...
},{"./printAllEvents":24}],19:[function(require,module,exports){
"use strict";
...
},{"./apiManager":18,"./editForm":21,"./eventForm":22,"./eventObject":23,"./printAllEvents":24}],21:[function(require,module,exports){
"use strict";
...
},{"./apiManager":18,"./buildSingleEvent":19,"./eventForm":22}],25:[function(require,module,exports){
"use strict";
...
_clicks.default.logout(); // document.querySelector("#task").innerHTML = form.newTaskForm()
...
_clicks2.default.createArticleAttempt();
...
},{"./auth/clicks":12,"./auth/forms":13,"./events/click":20,"./task/clicks":27,"./task/edit":28,"./task/handleEdit":29}],26:[function(require,module,exports){
"use strict";
...
},{"../NewsArticle/loadPageAfterLogin":10,"../auth/logout":15,"./apiManager":26,"./objectBuilder":30,"./printTask":31,"./taskForm":33}],28:[function(require,module,exports){
"use strict";
...
},{"./apiManager":26,"./handleEdit":29,"./taskForm":33}],29:[function(require,module,exports){
"use strict";
  ...
  document.querySelector("body").addEventListener("click", () => {
    if (event.target.classList.contains("newClass")) {
      ...
      _apiManager.default.editTask(taskId, object).then(() => {
        (0, _printTask.default)();
        document.querySelector("#new-task-container").innerHTML = "";
        document.querySelector("#task").innerHTML = _taskForm.default.createTask(); // document.querySelector("#new-task-container").innerHTML = form.taskForm()
      });
    }
  });
};
...
},{"./apiManager":26,"./objectBuilder":30,"./printTask":31,"./taskForm":33}],30:[function(require,module,exports){
"use strict";
...
},{"./apiManager":26,"./printTaskBuilder":32,"./taskForm":33}],32:[function(require,module,exports){
"use strict";
