...
const ChatCollection = {
  ...
  getAllChats: () => {
    return fetch("http://localhost:8088/messages?_expand=user").then(messages => messages.json());
  },
  deleteChat: chatId => {
  ...
  getSingleChat: chatId => fetch(`http://localhost:8088/messages/${chatId}`).then(r => r.json()),
