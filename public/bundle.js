...
const ChatCollection = {
  ...
  getSingleChat: chatId => {
    return fetch(`http://localhost:8087/messages/${chatId}`).then(r => r.json());
  },
...
const apiFetch = {
  ...
  editSingle: taskId => {
    return fetch(`http://localhost:8087/tasks/${taskId}`).then(r => r.json());
  },
