...
const chronology = () => {
  ...
  return fetch(`http://localhost:8089/articles?userId=${activeUserId}`).then(response => {
    ...
    const articleTimes = []; // Work with JSON Data Here:
...
const activateDeleteButtons = () => {
  ...
  document.querySelector("#articles-output").addEventListener("click", () => {
    ...
    if (event.target.classList.contains("delete")) {
      ...
      .then(_ArticleList.default); // chronology();
...
},{"./ArticleCollection":4,"./ArticleList":8}],6:[function(require,module,exports){
"use strict";
...
},{"./ArticleCollection":4,"./ArticleSaveEdit":10}],7:[function(require,module,exports){
"use strict";
...
},{"./ArticleCollection":4,"./ArticleList":8,"./ArticleObjectBuilder":9,"moment":1}],8:[function(require,module,exports){
"use strict";
...
},{"./Article.js":2,"./ArticleCollection.js":4,"moment":1}],9:[function(require,module,exports){
"use strict";
  ...
  document.querySelector("#form-output").addEventListener("click", () => {
    ...
    if (event.target.id.includes("edit-article")) {
      ...
      _ArticleCollection.default.editArticle(articleId, objectToPost).then(() => {
        ...
        document.querySelector("#form-output").innerHTML = _ArticleForm.default.buildForm(); // Displays ALL News Articles:
...
},{"./ArticleCollection":4,"./ArticleForm":7,"./ArticleList":8,"./ArticleObjectBuilder":9,"moment":1}],11:[function(require,module,exports){
"use strict";
...
const loadPageAfterLogin = () => {
  ...
  //Builds Article Form
  document.querySelector("#form-output").innerHTML += _ArticleForm.default.buildForm(); // Adds Event Listener to Save Button
...
},{"./ArticleDeletion.js":5,"./ArticleEditForm.js":6,"./ArticleForm.js":7,"./ArticleList.js":8}],12:[function(require,module,exports){
"use strict";
...
},{"./login":15,"./logout":16,"./register":18}],14:[function(require,module,exports){
"use strict";
...
},{"../NewsArticle/loadPageAfterLogin":11}],15:[function(require,module,exports){
"use strict";
...
},{"./apiManager":12,"./forms":14}],16:[function(require,module,exports){
"use strict";
...
},{"./forms":14}],17:[function(require,module,exports){
"use strict";
...
},{"./apiManager":12,"./forms":14,"./objectBuilder":17}],19:[function(require,module,exports){
"use strict";
...
var _ArticleArrayDateSort = _interopRequireDefault(require("./NewsArticle/ArticleArrayDateSort"));
